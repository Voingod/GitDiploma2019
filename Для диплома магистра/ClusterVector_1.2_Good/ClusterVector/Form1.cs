...
namespace ClusterVector
{
    public partial class Form1 : Form
    {
        ...
        //ParametrsData.Add(Convert.ToInt32());
       ...
       // string[] filterCl = new string[] { };
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if(rbtCl4.Checked)
                {
                    pathResultTable = Environment.CurrentDirectory + "/Table/ResultTableCl4.xls";
                }
                ...
                if (rbtWoman.Checked)
                {
                   ...
                   // = new double[] { 18.22, 21.79, 17.30, 23.25, 17.57, 20.42, 16.43, 18.82 };
                    radiusCl= RadiusCL.Radius(pathResultTable, "CL1, CL2, CL3, CL4, CL5, CL6, CL7, CL8", "Women");
                ...
                {
                    radiusCl = RadiusCL.Radius(pathResultTable, "CL1, CL2, CL3, CL4, CL5, CL6, CL7", "Men");
        ...
        private void dataGridViewFind_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                MessageBox.Show("Студент не имеент данных в БД");
            }
            ...
            if(Convert.ToDouble(lblRCl.Text) < Convert.ToDouble(lblRSt.Text))
            {
                ...
                lblConclusion.Text = "Студент выходит за пределы кластера";
                GrafInd();                
            }
            else
            {
                textBox2Zaglushka.Visible = true;
                lblConclusion.Text = "Студент не выходит за пределы кластера";
            }
